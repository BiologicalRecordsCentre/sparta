...
test_that("Test WSS2", {
  ...
  expected <- structure(list(species_name = structure(1:24, .Label = c("j", 
                             ...
                             intercept.estimate = c(-1.57619083577126, -13.8495754516103, 
                                                    ...
                                                    -291.923839798309, -1.91006662549916, -2.475926206912, -1.33051949786452, 
                                                    -2.81871216623466, -2.83618515608237),
                             year.estimate = c(-0.137664655677721, -0.255972184926112, 0.0243500035155962, -0.566460540397709,
                                               ...
                                               -0.25123726518694, 0.0864040814080048, 36.4904799747384, 
                                               -0.0856616201509247, 0.052983985418381, 0.171895782899429, 
                                               0.174123271705114, -0.11415650840461),
                             intercept.stderror = c(0.87271447234245, 12.5543883737514, 0.662379880798868, 3.21124050127362, 0.703719558001864, 
                                                    ...
                                                    0.803704485290518, 2774.46370100024, 0.914854669875221, 1.05340271760867, 
                                                    0.790145647086538, 1.431954215685, 1.41652735197116),
                             year.stderror = c(0.127899223807658, 1.28363767963825, 0.0993400015871386, 0.569115067435634, 
                                               ...
                                               0.120974440363535, 346.807997941976, 0.132954541387084, 0.157909924089591, 
                                               0.121915716838618, 0.203949491797337, 0.198270242835728), 
                             intercept.zvalue = c(-1.80607848926879, -1.10316608338857, -1.78568613159273, -0.82484828231442, -1.82423488433382, 
                                                  ...
                                                  -2.08982127779059, -1.6884056765115, -2.13622406648812, -0.105218114655119, 
                                                  -2.08783612129309, -2.35040803058929, -1.6838914480773, -1.96843735320566, 
                                                  -2.00220994824823), 
                             year.zvalue = c(-1.07635254991656, -0.199411554355625, 0.245117808803707, -0.995335693623635, -0.449216388569914, 
                                             ...
                                             0.714234189869824, 0.105218103940162, -0.644292547341645, 
                             ...
                             intercept.pvalue = c(0.070906080305768, 0.269955047232846, 
                                                  ...
                                                  0.0326611547082257, 0.916202737090794, 0.0368126199963619, 
                                                  0.0187528413234339, 0.0922026493889603, 0.0490177375929778, 
                                                  0.0452621561999708),
                             year.pvalue = c(0.281769614946285, 0.841940822917499, 0.806365214045797, 0.319573023285896, 0.653275566248193, 
                                             ...
                                             0.47508237862208, 0.916202745592899, 0.51938574744968, 0.737223080155663, 
