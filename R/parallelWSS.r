#' Parallelised well sampled sites (WSS) trend analysis
#' 
...
#' the number of cores to be used. Additionally warning messages from slaves are
...
#' @param od This option allows modelling overdispersion (\code{TRUE}) in WSS models.
