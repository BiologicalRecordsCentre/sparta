...
function(gridrefs, attribute = NULL, breaks = NULL, shape_data = UK, xlim = NULL, ylim = NULL, grid.div = 100000, gr_prec = 10000, sq_border = NULL,sq_col = NA, legend_pos = "topleft", leg_cex = 0.4, ...){
		...
		plot.GIS(shape_data, new.window = FALSE, blank.plot = TRUE, xlim = xlim, ylim = ylim, grid.div = grid.div, ...)
		...
		plot.GIS(shape_data, new.window = FALSE, additions = TRUE, xlim = xlim, ylim = ylim, grid.div = grid.div, ...)
	}
