all_oneplots <-
function(stat, trend, freq, spp_names = NULL, onefile = TRUE, onefile_name = NULL, dev_type = "pdf", dir_path = getwd(), dev_args = list(height = 11, width = 7), save_lm_stats = TRUE, stats_fname = "Frescalo Tfactor lm stats.csv"){
