...
#' @param timeperiod A numeric vector of user defined time periods, or a date vector,
...
WSS2 <- function(taxa, site, time_period, minL = 2, minTP = 3, overdispersion = FALSE, verbose = FALSE, print_progress = FALSE){
