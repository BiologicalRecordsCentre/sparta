...
test_that("Test formulaBuilder", {
  ...
  expect_identical(model_formula, "taxa ~ year + listLength")
  model_formula <- formulaBuilder(family,TRUE,TRUE,overdispersion)
  expect_identical(model_formula, "taxa ~ year + listLength + (1|site)")
  model_formula <- formulaBuilder(family,TRUE,TRUE,TRUE)
  expect_identical(model_formula, "taxa ~ year + listLength + (1|site) + (1|obs)")
